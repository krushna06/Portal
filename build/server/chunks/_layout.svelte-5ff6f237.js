...
const TopBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="bg-white dark:bg-slate-700 my-8 p-4 rounded-xl shadow-sm"><div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:mx-8"><div><a${add_attribute("href", base + "/settings", 0)} class="flex justify-center md:justify-start">
				<img src="https://media.discordapp.net/attachments/890634398981042246/1248840765678030919/bytebridge_1.png?ex=66652118&is=6663cf98&hm=017345e22ba01766400f58d77d8d16b923068e741d2ec7efa55daa5a10be68fb&=&format=webp&quality=lossless&width=825&height=676" alt="ByteBridge Limited" style="border-radius: 50%; width: 64px; height: 64px;"></a></div>
...
//# sourceMappingURL=_layout.svelte-5ff6f237.js.map
